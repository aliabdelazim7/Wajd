...
const SocialProof = ({ projects = [] }) => {
    ...
    const copy = isArabic ? {
        ...
        cmsReady: 'جاهز للإضافة من لوحة التحكم',
    } : {
